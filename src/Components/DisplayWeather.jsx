...
export default function DisplayWeather({ coordinates }) {
  ...
  return (
    <div>
      <div className=" fixed top-1/5 left-1/4  font-sans p-5 shadow-2xl  w-1/2  rounded-4xl  bg-white/20">
              ...
              <div className="pt-1 p-4 font-semibold text-blue-800">
                <p>
                  ...
                  {celsiusTemp === "C"
                    ...
                    : `${Math.round(weather.main.feels_like * 1.8 + 32)}°F`}
                </p>
              </div>
              <div className="flex flex-row">
                <IconDisplay
                  ...
                  value={
                    celsiusTemp === "C"
                      ...
                      : `${Math.round(weather.main.temp_min * 1.8 + 32)}°F`
                  }
                />
                <IconDisplay
                  ...
                  value={
                    celsiusTemp === "C"
                      ...
                      : `${Math.round(weather.main.temp_max * 1.8 + 32)}°F`
                  }
                />
              </div>
              <IconDisplay
